...
void cshake128_simple_squeezeblocks (unsigned char *output,
...
void cshake128_simple (unsigned char *output,
...
void cshake256_simple_absorb (uint64_t s[25],
                              uint16_t cstm,
                              const unsigned char *in,
                              unsigned long long inlen) {
    unsigned char sep[8];
...
void cshake256_simple_squeezeblocks (unsigned char *output,
                                     unsigned long long nblocks,
                                     uint64_t *s) {
    keccak_squeezeblocks (output, nblocks, s, SHAKE256_RATE);
}
...
void cshake256_simple (unsigned char *output,
                       unsigned long long outlen,
                       uint16_t cstm,
                       const unsigned char *in,
                       unsigned long long inlen) {
